...
- `v1/actions/session-request.schema.json` defines the additive session open, explicit choice, message audit and document-switch revocation actions used by the pyRevit panel and local Agent.
